...
Module Module1
    ...
    Sub Main()
        ' Converts a Project object into JSON and saves it to disk.
        SerializePlayer()
    ...
    End Sub
    ' Creates the folder structure for a new ChronoVault project.
    ...
    End Sub
    ' Writes the README.txt file to the selected folder.
...
The project was created by Kimberly Aguilar, with guidance from course materials and class instruction.")
    ...
    ' Creates a project folder if it does not already exist.
    ...
    Sub SerializePlayer()
        ...
        myProject.FullDirectory = FullDirectory
        myProject.LastSaved = DateTime.Now.ToString()
